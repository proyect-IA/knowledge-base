...
abrir(KB):- 
	...
	open('d:/maestria/inteligenciaArtif/knowledge-base/proyecto_2/bases/KB2_edd.txt',read,Stream),
...
guardar(KB):-
	...
	open('d:/maestria/inteligenciaArtif/knowledge-base/proyecto_2/bases/Test.txt',write,Stream),
...
cambiar_ubicacion_robot(NuevaUbucacion,KB,NuevaKB):-
	cambiar_elemento(class(robot,top,Propiedades,Relaciones,[[id=>[marvin],[Ver,Ini,_,ManoDer, ManoIz],Rels]]),
                    class(robot,top,Propiedades,Relaciones,[[id=>[marvin],[Ver,Ini,ubic_actual=>(NuevaUbucacion,0),ManoDer,ManoIz],Rels]]),
                    KB,NuevaKB).

tomar_objeto_derecha_robot(Objeto,KB,NuevaKB):-
	cambiar_elemento(class(robot,top,Propiedades,Relaciones,[[id=>[marvin],[Ver,Ini,Actual,ManoDer, ManoIz],Rels]]),
                    class(robot,top,Propiedades,Relaciones,[[id=>[marvin],[Ver,Ini,Actual,mano_der=>(Objeto,0),ManoIz],Rels]]),
                    KB,NuevaKB).

tomar_objeto_izquierda_robot(Objeto,KB,NuevaKB):-
	cambiar_elemento(class(robot,top,Propiedades,Relaciones,[[id=>[marvin],[Ver,Ini,Actual,ManoDer, ManoIz],Rels]]),
                    class(robot,top,Propiedades,Relaciones,[[id=>[marvin],[Ver,Ini,Actual,ManoDer,mano_izq=>(Objeto,0)],Rels]]),
                    KB,NuevaKB).


obtener_ubicacion_robot(UbicActual, KB):-
	es_elemento(class(robot,top,Propiedades,Relaciones,[[id=>[marvin],[Ver,Ini,ubic_actual=>(UbicActual,0),ManoDer,ManoIz],Rels]]),KB).
