...
abrir(KB):- 
	...
	open('d:/maestria/inteligenciaArtif/knowledge-base/examen/baseExamen.txt',read,Stream),
...
guardar(KB):-
	...
	open('d:/maestria/inteligenciaArtif/knowledge-base/examen/baseExamen.txt',write,Stream),
	writeq(Stream,KB),
	close(Stream).
...
iterar_individuos_relaciones(_,_,[],[]).

iterar_individuos_relaciones(Name,NewName,
        [[id=>Ids,Prop,[Rels,PrefRels]]|T],[[id=>Ids,Prop,[NewRels,PrefRels]]|N]):-
    cambiar_objeto_objeto_en_relacion(Name,NewName,Rels,RelsNewAux),
    cambiar_objeto_objeto_en_relacion_neg(Name,NewName,RelsNewAux,NewRels),
    iterar_individuos_relaciones(Name,NewName,T,N).

iterar_individuos_relaciones(Name,NewName,[H|T],[H|N]):-
    iterar_individuos_relaciones(Name,NewName,T,N).
...
cambiar_relaciones_nivelIndividuo(Nombre,NombreNuevo, 
        [class(C,Padre,P,R,Objectos)|T],
        [class(C,Padre,P,R,ObjectosNuevos)|N]):-
	iterar_individuos_relaciones(Nombre, NombreNuevo, Objectos, ObjectosNuevos),    
